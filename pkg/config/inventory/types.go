...
type Config struct {
	Inventory []*Entry `mapstructure:"inventory"`
}
...
type Entry struct {
	...
	ConfigNamesace string `mapstructure:"config_namespace"`
...
func decode(data *map[interface{}]interface{}, result interface{}) error {
...
// inventory config
func NewConfigFromMap(data *map[interface{}]interface{}) (*Config, error) {
	var config Config
